<template>
  <div class="w-full" @mouseenter="isHover = true" @mouseleave="isHover = false">
    <div class="relative pb-5/6 rounded-lg shadow-md overflow-hidden">
      <img
        class="absolute h-full w-full object-cover"
        :src="property.imageUrl"
        :alt="property.imageAlt"
      />
      <mask-slot v-if="isHover">
        <button>
          <svg
            class="text-white w-12 h-12 opacity-100 fill-current text-white"
